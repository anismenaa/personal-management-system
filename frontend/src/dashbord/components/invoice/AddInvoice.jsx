...
import InvoiceGeneratorPdf from './InvoiceGeneratorPdf'
...
const AddInvoice = ({setAddClicked}) => {
    ...
    const handleDownloadInvoiceBtn = ()=>{
        ...
        <div className="h-screen">
            {
                ...
                !showPdfInvoice && <div className="relative h-3/4 shadow-lg inset-black-500 rounded-lg p-5">
                    <button onClick={()=>setAddClicked(false)} className="cursor-pointer">
                        <img src="./icons8-effacer.svg" className="h-5 w-5" />
                    </button>
...

            {
                ...
                <div className="static w-full h-3/4">
                    <button onClick={()=>setShowPdfInvoice(false)} className="cursor-pointer">
                        <img src="./icons8-effacer.svg" className="h-5 w-5" />
                    </button>
                    <InvoiceGeneratorPdf journeesImpaied={journeesUnpaied} total={totalInvoice} />
            ...
            <div className="absolute bottom-5 right-5 flex gap-2">
                {
                    ...
                    <button
                        ...
                        onClick={handleDownloadInvoiceBtn}
                    >
                        Show Invoice
                    </button>
                }
